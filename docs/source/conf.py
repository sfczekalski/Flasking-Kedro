...
# flasking_kedro documentation build
...
from flasking_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "flasking_kedro"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "flasking_kedrodoc"
...
man_pages = [
    (master_doc, "flasking_kedro", "flasking_kedro Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "flasking_kedro",
        "Project flasking_kedro codebase.",
        "Data-Science",
    )
]
